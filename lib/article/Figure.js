...
const _LicenseByline = require('../license/LicenseByline');

const _LicenseByline2 = _interopRequireDefault(_LicenseByline);
...
const FigureDetails = exports.FigureDetails = function FigureDetails(_ref) {
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          classes('list'),
          authors.map(author => _react2.default.createElement(
              'li',
...
const FigureCaption = exports.FigureCaption = function FigureCaption(_ref2) {
...
const Figure = function Figure(_ref3) {
