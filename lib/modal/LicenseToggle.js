...
const LicenseToggle = (function (_Component) {
  ...
  function LicenseToggle() {
    ...
    const _this = _possibleConstructorReturn(this, (LicenseToggle.__proto__ || Object.getPrototypeOf(LicenseToggle)).call(this));
